...
## 2026-07-24（Deep Research 补充校勘 · 新增 12 件）

- 🔬 **新增 12 件经多源交叉校勘的碑帖/简牍/青铜释文**（Deep Research 工作流，每件 2–3 权威源）：
  - 先秦简牍青铜（秦汉 4）：睡虎地秦墓竹简·田律、里耶秦简·更名方、中山王厝鼎、郭店楚简《老子》甲本
  - 宋元明次级名家（宋辽金 2 / 元明清 4）：李建中《土母帖》、林逋《自书诗卷》、鲜于枢《老子道德经卷》、王铎《赠张抱一草书诗卷》、邓石如《篆书千字文》、赵之谦《篆书铙歌册》、伊秉绶《遂性草堂》、吴昌硕《临散氏盘》
- 可信度：10 件 high、2 件 medium（邓石如《篆书千字文》藏本存疑、吴昌硕《临散氏盘》临本非一，均已在 `note` 标注）。
- 新增 `释文/新增碑帖释文校勘报告.md`（12 件逐条释文+校勘/异文+译文+考释+来源）。
- 数据集总数 482 → **494**（`validate.py` 494/494 通过）。
